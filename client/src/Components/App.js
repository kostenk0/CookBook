      ...
      <Router>
        <div className="App">
          ...
          <div className="row justify-content-around">
            ...
            <Route path="/add" render={() => <RecipeForm type="add" fields={{ title: ["text", "Назва"], description: ["text", "Додайте опис"] }} addRecipe={this.add.bind(this)} />} />
            <Route path="/edit" render={() => <RecipeForm type="edit" fields={{ title: ["text"], description: ["text"] }} Recipes={this.state.Recipes} RecipeUpdate={this.onRecipeUpdate} selectedId={this.state.selectedRecipe} endClickRecipe={this.onEndClickRecipe} />} />
